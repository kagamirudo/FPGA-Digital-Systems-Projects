...
set_property display_name "Stack Processor 101 with scpb (AXI4-Lite)"    $core
set_property description  "Assignment PDF's stack processor (sc/sl/ss/sadd/scp) extended with the new block-copy instruction scpb, wrapped in an AXI4-Lite slave for ECEC 661 Homework 5." $core
