...
## RGB LEDs
## LD0: bits [2:0] = {R, G, B} ; LD1: bits [5:3] = {R, G, B}
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { rgb_leds_tri_o[0] }]; #IO_L21P_T3_DQS_AD14P_35 Sch=led0_r
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { rgb_leds_tri_o[1] }]; #IO_L16P_T2_35           Sch=led0_g
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { rgb_leds_tri_o[2] }]; #IO_L22N_T3_AD7N_35      Sch=led0_b
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { rgb_leds_tri_o[3] }]; #IO_L23N_T3_35           Sch=led1_r
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { rgb_leds_tri_o[4] }]; #IO_L22P_T3_AD7P_35      Sch=led1_g
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { rgb_leds_tri_o[5] }]; #IO_0_35                 Sch=led1_b
